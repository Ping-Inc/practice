...
class MonthNavigationCell extends StatelessWidget {
  const MonthNavigationCell({super.key, required this.time});
  ...
  Widget build(BuildContext context) {
    return NavigationCell(
        ...
        label: TimeFilterEnum.month.toTitle(),
        value: DateFormat(TimeFilterEnum.month.toDateFormat()).format(time));
  }
}
